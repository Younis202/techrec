...
const TestimonialSection = () => {
    ...
    const testimonials = [
        ...
        },
        {
            ...
            rating: 5,
            text: `After months of unsuccessful searching, TechDeutsch helped us fill our staffing gaps. The Iraqi professionals bring not only excellent medical knowledge but also a remarkable work ethic.\n\nThe follow-up support was exemplary - even after a year, they still provide us with advisory support.`,
            metrics: {
        ...
        },
        {
            ...
            rating: 5,
            text: `As a smaller facility, we were skeptical about whether we could successfully integrate international professionals. TechDeutsch helped us not only with placement but also with cultural integration.\n\nOur residents and team are thrilled with the warmth and competence of our new colleagues.`,
            metrics: {

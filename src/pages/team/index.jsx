...
const TeamPage = () => {
    ...
    const teamMembers = [
        ...
        },
        {
            ...
            experience: `Lisa developed TechDeutsch's innovative language curriculum, specifically tailored for medical professionals. She combines classical language pedagogy with VR technology and simulations of real clinic situations.\n\nHer programs achieve a 95% success rate for B2 certifications and reduce preparation time by an average of 30%. Lisa is a certified BAMF course instructor and examiner for medical language.`,

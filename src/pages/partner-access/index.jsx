...
const PartnerAccessPage = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Partner Access - TechDeutsch Healthcare Staffing</title>
                <meta name="description" content="Become a TechDeutsch partner and gain access to qualified Iraqi healthcare professionals. Simple onboarding process for German healthcare institutions." />
                <meta name="keywords" content="become partner, healthcare professionals, staffing agency, German clinics, Iraqi nurses" />
                <meta property="og:title" content="Partner Access - TechDeutsch Healthcare Staffing" />
                <meta property="og:description" content="Become a TechDeutsch partner and gain access to qualified Iraqi healthcare professionals." />
